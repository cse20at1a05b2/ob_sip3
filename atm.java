...
class accountofbank{
    static  void registers(){
        ...
        System.out.print("press your Account number - ");
...
class transactions{
    static void withdraw(){
        Scanner sc=new Scanner(System.in);
        System.out.println("----------------");
        System.out.print("press withdraw amount - ");
    ...
    static void transferDetails(){
        ...
        System.out.print("reciever account number - ");
        int num=sc.nextInt();
        System.out.print("Transferred payment is - ");
...
public class ATM{
    ...
    public static void homepage(){
        ...
        System.out.print(" No of choice Enter : ");
